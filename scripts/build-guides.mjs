...
const GUIDES = [
  ...
  // ---- Batch 4: the celebratory moments (balance the library toward "celebrations and hard days alike") ----
  {
    ...
    gestures: [
      ["Give the gift of a memory", "Beyond the registry, an experience — a dinner out, a contribution toward the honeymoon — becomes a story they'll retell."],
  ...
  },
  {
    ...
    meta: "Meaningful things to write in a milestone birthday card — 30th, 40th, 50th and beyond — messages that celebrate the person, what to avoid, and thoughtful ways to mark a big year.",
    h1: "What to write in a milestone birthday card",
    begin: "Someone I care about has a big milestone birthday",
    intro: [
      "A milestone birthday — 30, 40, 50, 60 — deserves more than 'happy birthday, you're old now!' These are the years people quietly take stock of their lives, and a thoughtful word can land far deeper than the usual joke about age.",
    ...
    followUp: "The party ends, but a milestone year often stirs bigger questions about what's next. A check-in a few weeks later — 'how are you feeling about this new chapter?' — shows you saw past the balloons to the real person.",
    faq: [
  ...
  },
  {
    ...
    gestures: [
      ...
      ["Give a gift toward the next chapter", "Something for what's ahead — gear for a hobby, a trip, a class they've wanted to take — says you believe in their future."],
      ["Mark the transition together", "A dinner or gathering to send them off makes the milestone feel seen, not just clocked out."],
    ],
    followUp: "The send-off is exciting; the quiet Monday a few weeks later, when the calendar's suddenly empty, can be harder than expected. A check-in then — 'how's the new rhythm treating you?' — shows you understood retirement is a real transition, not just a party.",
    faq: [
  ...
  },
  {
    ...
    faq: [
      ...
      ["How do you celebrate someone's engagement?", "Mark the engagement itself — take them out, toast them, or send a small treat — before the wedding planning starts. A heartfelt note about the two of them is always welcome."],
...
<div class="wrap">
  <header class="bar">
    <a class="brand" href="/"><svg viewBox="0 0 100 100" aria-hidden="true"><path d="M50 12c21 0 36 14.5 36 33 0 18.5-15 33-36 33-4.6 0-9-0.7-13-2l-16 8 4.4-15.4C15.7 96.2 14 84.5 14 45 14 26.5 29 12 50 12Z" fill="none" stroke="#118ab9" stroke-width="7" stroke-linejoin="round"/><path fill="#ef4136" d="M50 63c-1 0-1.9-.4-2.6-1.1l-11-11a8.8 8.8 0 0 1 0-12.5 8.8 8.8 0 0 1 12.5 0l1.1 1.1 1.1-1.1a8.8 8.8 0 0 1 12.5 0 8.8 8.8 0 0 1 0 12.5l-11 11c-.7.7-1.6 1.1-2.6 1.1Z"/></svg>Thoughts Count</a>
...
${TRACKER}
<div class="wrap">
  <div class="bar"><a class="brand" href="/"><svg viewBox="0 0 100 100" aria-hidden="true"><path d="M50 12c21 0 36 14.5 36 33 0 18.5-15 33-36 33-4.6 0-9-0.7-13-2l-16 8 4.4-15.4C15.7 96.2 14 84.5 14 45 14 26.5 29 12 50 12Z" fill="none" stroke="#118ab9" stroke-width="7" stroke-linejoin="round"/><path fill="#ef4136" d="M50 63c-1 0-1.9-.4-2.6-1.1l-11-11a8.8 8.8 0 0 1 0-12.5 8.8 8.8 0 0 1 12.5 0l1.1 1.1 1.1-1.1a8.8 8.8 0 0 1 12.5 0 8.8 8.8 0 0 1 0 12.5l-11 11c-.7.7-1.6 1.1-2.6 1.1Z"/></svg>Thoughts Count</a></div>
  <div class="hero">
