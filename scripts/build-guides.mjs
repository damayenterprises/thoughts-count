...
const GUIDES = [
  ...
  // ---- Batch 6 (TC-175 wave 2): GSC-demand-grounded expansion ----
  {
  slug:"how-to-sign-a-card", tone:"everyday",
  title:"How to Sign a Card",
  meta:"How to sign a card and close it well: warm and casual and formal sign-offs, what to avoid, and how the closing line changes by occasion, from weddings to sympathy to your boss.",
  h1:"How to sign a card", begin:"I need to sign a card and don't know how to close it",
  intro:["You've written the message, and now you're stuck on that last line before your name. The sign-off is small, but it sets the whole tone, and the wrong one can make a heartfelt card feel stiff or a formal card feel too casual.","Here's how to pick a closing that fits the person and the occasion, plus lines you can borrow and a few to skip."],
  matters:"The sign-off is the last thing they read, so it lingers. It tells them how close you two are and how much care you meant, all in one short line.",
  say:[["“Love,”","For family and close friends. Warm and simple, and it never feels like too much with people you actually love."],["“With love,”","A touch softer and fuller than plain Love. Nice for a parent, a partner, or a very dear friend."],["“Take care,”","Friendly and easy for a coworker, a neighbor, or someone you like but aren't especially close to."],["“Warmly,”","A little more polished. Good for a boss, a client, or someone you respect but don't know well."]],
  avoid:[["“Sincerely,” on a card for a close friend","It reads like a business letter and puts distance between you where there shouldn't be any."],["“Best,” with no context","Fine in email, but on a card it can feel clipped and like you ran out of things to say."],["Signing your full name to your own mother","Just your first name, or your family nickname, keeps it personal. The full name is for people who might not place you."]],
  gestures:[["Add one specific line above your name","A single sentence like “So glad you're in my life” does more than any fancy sign-off."],["Sign for the whole household by name","“Love, Ana, Mark, and the kids” feels warmer than “The Garcias” and shows you each thought of them."],["Match your handwriting to the moment","Slow down for a sympathy or wedding card. A rushed scrawl can undercut a warm message."],["Note who it's from if there's any doubt","If they know a few people with your first name, add a hint so they smile instead of squint."]],
  gesturesHeading:"Small touches that make a sign-off land",
  sections:[{h:"How to sign based on the occasion",rows:[["A wedding card","Warm and celebratory. “With love and every good wish,” or simply “So happy for you both, Love,” then your name. Sign for your partner or family too if you came together."],["A birthday card","Match your closeness. “Love,” for close people, “Happy birthday, take care,” for friendlier acquaintances. A little playfulness is welcome here."],["A sympathy card","Gentle and unhurried. “With deepest sympathy,” or “Thinking of you and holding you close,” then your name. Skip anything upbeat or breezy."],["A card for a boss or coworker","Warm but professional. “Warmly,” or “All the best,” works well. Save “Love” for people outside of work unless you're genuinely close."],["Someone you don't know well","Keep it kind and a little more formal. “Best wishes,” or “Take care,” then your first and last name so they know exactly who it's from."]]}],
  followUp:"If you signed a card for something big, like a wedding or a loss, a short message a week or two later means even more, once the pile of cards has thinned out and things go quiet.",
  faq:[["How do you sign a card?","Pick a closing that matches how close you are, like “Love,” for family and “Warmly,” for a coworker, then write your name below it."],["How do you sign a wedding card?","Warm and celebratory, such as “With love and every good wish,” followed by your name, and include your partner or family if you came together."],["What can I write instead of Sincerely?","On a personal card, try “Warmly,” “Take care,” “All the best,” or “With love,” depending on how well you know them. Save Sincerely for formal letters."],["How do you sign a sympathy card?","Keep it gentle and unhurried, like “With deepest sympathy,” or “Thinking of you,” then your name. Avoid anything upbeat."],["Should I sign my full name?","Use just your first name for people who know you well. Add your last name only when the person might not immediately place who you are."],["How do you sign a card from a family?","List each person by name, such as “Love, Ana, Mark, and the kids,” rather than a group label. It feels more personal."]],
  related:["what-to-write-in-a-wedding-card","what-to-write-in-a-birthday-card","what-to-write-in-a-sympathy-card"],
  },
  {
  slug:"what-to-say-when-someone-loses-a-spouse", tone:"hard",
  title:"What to Say When Someone Loses a Spouse",
  meta:"Gentle, specific things to say when someone loses their husband or wife, what to avoid, gestures that help, and how to keep showing up in the lonely months after.",
  h1:"What to say when someone loses a spouse", begin:"Someone I care about just lost their spouse",
  intro:["When someone loses a spouse, they haven't just lost a person. They've lost the one they built their whole daily life around, the voice across the table, the hand they reached for in the dark. It is one of the deepest losses there is, and the fear of saying the wrong thing can leave you frozen and silent, which is the one thing that hurts them most.","You don't need perfect words. Here are things that genuinely help, things to avoid, and small ways to stay close long after the crowd thins out."],
  matters:"Their world just came apart at the center. They don't need their grief fixed or brightened. They need to know you see how enormous this is, and that you are not going anywhere. Steady beats profound. Specific beats grand.",
  say:[["“I can't imagine how much you're missing him. I'm so sorry, and I'm here.”","Naming the missing shows you grasp the size of it without pretending to fully understand."],["“She was the kind of person who… I'll always carry that.”","A specific memory of their spouse tells them the person they loved is still real to you too."],["“I'm bringing dinner Tuesday, is 6 okay? You don't have to talk, I'll just leave it and go.”","A concrete action with an easy out, in the weeks when even eating feels impossible."],["“You don't have to be okay around me.”","Gives them permission to fall apart instead of performing strength for company."]],
  avoid:[["“At least you had so many good years together.”","A silver lining can feel like a reason they shouldn't be grieving the future they lost."],["“He would want you to move on.”","It rushes them and quietly pushes dating or letting go long before they're ready."],["“Let me know if you need anything.”","It hands the work to someone who can barely get through the day. Offer something specific instead."]],
  gestures:[["Bring food that keeps","Meals for the freezer, for the nights when cooking for one is too much."],["Handle one quiet task","Field the phone calls, mow the lawn, answer the paperwork, one load lifted without being asked."],["Sit in the empty house with them","Your presence in the silence says more than any words can."],["Write the memory down","A short note about their husband or wife becomes something they keep and reread."]],
  gesturesHeading:"Gestures that carry more than words",
  sections:[{h:"What to say based on your relationship",rows:[["A close friend","Be direct and stay: 'I'm here, and I'm not going anywhere. We'll get through this together, one day at a time.' Then keep proving it by showing up."],["A family member","Share the grief openly, and carry the practical weight so they don't have to: 'I've got the arrangements and the calls. You just breathe.'"],["A coworker or acquaintance","Keep it brief and warm: 'I'm so sorry for your loss. There's no rush on anything here, take the time you need.' Then protect their space quietly."],["Much later, in the lonely months after","Say the name out loud: 'I was thinking about David today, and how he always… I still miss him too.' The lonely stretch is when they most need to know he isn't forgotten."]]}],
  followUp:"The hardest time isn't the funeral. It's the empty house months later, when the casseroles have stopped and everyone else has gone back to their lives. That is when the loneliness truly settles in. Set reminders for two weeks out, one month, the first holidays, and the one-year mark, and keep reaching out long after you think you should have to.",
  faq:[["What do you say to someone whose spouse just died?","Be honest and gentle. Say you're so sorry, acknowledge how much they must be missing their husband or wife, share one specific memory, and offer a concrete gesture instead of a vague 'let me know if you need anything.'"],["What should you not say to a grieving widow or widower?","Avoid silver linings like 'at least you had good years' and anything that rushes them, like 'he would want you to move on.' Don't bring up dating or moving forward. Let them grieve at their own pace."],["How do you comfort someone who lost their husband or wife?","Show up in practical, steady ways. Bring food, handle a task, sit with them in the quiet, and keep checking in over the long months after, not just in the first week."],["Is it okay to talk about the person who died?","Yes. Many grieving people long to hear their spouse's name and stories. Saying the name and sharing a memory tells them their person is remembered and still matters."],["What can I do to help besides saying something?","Offer specific, concrete help: drop off a meal that freezes well, field phone calls, mow the lawn, or take on a piece of paperwork. Small burdens lifted mean more than words in the early weeks."],["How long should I keep checking in?","Far longer than most people do. Grief for a spouse doesn't fade on a schedule. Reach out at one month, the first holidays, birthdays, and the one-year mark, and simply keep them in your regular life."]],
  related:["what-to-say-when-someone-loses-a-parent","ways-to-help-a-grieving-friend","what-to-write-in-a-sympathy-card"],
  },
  {
  slug:"what-to-say-when-someone-loses-a-grandparent", tone:"hard",
  title:"What to Say When Someone Loses a Grandparent",
  meta:"Warm, specific things to say when someone loses a grandparent, what to avoid, and small gestures that help, without minimizing a real and often first loss.",
  h1:"What to say when someone loses a grandparent", begin:"A friend just lost their grandparent",
  intro:["Losing a grandparent is often someone's first real brush with grief, and the world can quietly shrink it with lines like they were old or it was expected. That framing stings, because a loved grandparent is not a small loss.","Here are things that genuinely help, things to skip, and small gestures that carry more weight than you might think."],
  matters:"They may be grieving a person who was woven through their whole childhood, and they may also be scared because they have never felt this before. What helps is being told the loss is real and being reminded they are not alone in it.",
  say:[["“I'm so sorry. Your grandmother mattered, and this is a real loss.”","Naming it as real pushes back against everyone who is minimizing it."],["“What was she like? I'd love to hear about her.”","An invitation to talk keeps the person alive in the conversation."],["“There's no timeline on this. I'm here whenever you need me.”","First grief can feel confusing, and this gives them permission to feel it fully."],["“I remember how you lit up talking about him.”","A specific memory shows you saw how much this person meant to them."]],
  avoid:[["“Well, they lived a long life.”","It sounds like the loss should hurt less, and it does not."],["“At least it was expected.”","Expected does not mean easy, and this can make them feel silly for grieving."],["“You'll be okay, you barely saw them lately.”","It quietly ranks their grief and tells them it does not count."]],
  gestures:[["Drop off something easy to eat","Food that goes straight in the fridge or freezer, no reply needed."],["Send a memory in writing","A short note about their grandparent becomes something they keep."],["Sit with them, no agenda","Company without pressure to talk says the loss is worth showing up for."],["Check in after the funeral","A message a week later matters when everyone else has moved on."]],
  gesturesHeading:"Small gestures that help",
  sections:[{h:"What to say based on your relationship",rows:[["A close friend","Be direct and stay close. Say the loss is real, ask about their grandparent, and keep checking in past the first week."],["A younger person facing their first loss","Gently name that grief feels strange the first time and there is no wrong way to feel it. Let them know it makes sense to hurt this much."],["A coworker","Keep it brief and warm. A simple I'm sorry for your loss, please take the time you need, respects their privacy without ignoring it."],["Someone extremely close to their grandparent","Acknowledge the size of it. Say something like I know how much they meant to you and treat it with the weight of losing a parent, because for them it may be."]]}],
  followUp:"The quiet stretch comes after the cards stop, often two or three weeks in. Set a reminder to reach out then, and again near the one month mark, just to say you are thinking of them.",
  faq:[["What do you say when someone's grandparent dies?","Keep it warm and specific. Tell them the loss is real, invite them to share a memory, and avoid anything that shrinks their grief."],["What should you not say?","Skip they lived a long life and it was expected. Those lines feel dismissive, especially when this may be someone's first big loss."],["Is it okay to grieve a grandparent a lot?","Yes. A grandparent is often part of someone's entire childhood, and it can be their first real loss, so deep grief is completely normal."],["What if I did not know their grandparent?","You can still help. Ask what they were like, listen, and focus on supporting your friend rather than needing a shared memory."],["How do I support someone weeks later?","Reach out after the attention fades. A short message near the two week and one month marks tells them you have not forgotten."],["Should I say something to a coworker?","A brief, private note of condolence is kind and appropriate. Acknowledge the loss, offer patience, and do not press for details."]],
  related:["what-to-say-when-someone-loses-a-parent", "what-to-write-in-a-sympathy-card"],
  },
  {
  slug:"what-to-write-in-a-farewell-card-for-a-coworker", tone:"celebration",
  title:"What to Write in a Farewell Card for a Coworker",
  meta:"Warm, non-cliché things to write in a farewell card for a coworker who is leaving: sample messages, what to skip, and thoughtful ways to send them off well.",
  h1:"What to write in a farewell card for a coworker", begin:"A coworker is leaving and I need to sign their farewell card",
  intro:["When a coworker moves on, whether to a new job, retirement, or a fresh chapter somewhere else, a farewell card can end up as a wall of hurried signatures. A couple of real lines stand out and stay with them.","Here is what to write, what to leave off, and a few ways to send them off that go past the card itself."],
  matters:"The lines people remember name something specific: a project you got through together, the way they treated the team, a small kindness. Warm and particular always beats a polished blank.",
  say:[["“It has been a genuine pleasure working alongside you, and the place will feel different without you.”","Naming the gap you will feel is honest and kind."],["“Thank you for always making time to help, even on your busiest days. I learned a lot from you.”","A specific thank-you shows you paid attention."],["“Wishing you every good thing in this next chapter. They are lucky to have you.”","A forward-looking wish fits a fresh start."],["“I will miss our morning check-ins more than the coffee.”","A small shared detail proves the note came from you."]],
  avoid:[["“Don't forget us little people when you're famous!”","A joke about being forgotten can land as insecure."],["“Lucky you, getting out of this place.”","Complaints about work sour their send-off."],["Just your name and nothing more","On a farewell card it reads like you barely noticed they were leaving."]],
  gestures:[["Say it out loud too","A few honest words in person land harder than any card."],["Send the longer note after","A message once they have settled in reminds them the bond outlasts the desk."],["Offer to stay in touch, and mean it","Trading a real way to reach you turns a goodbye into a keep in touch."],["Mark the send-off","Lunch or a small gathering gives the team a proper way to close the chapter."]],
  gesturesHeading:"Ways to send them off well",
  sections:[{h:"What to write depending on your relationship",rows:[["A close work friend","Be personal and a little tender. Name what you will actually miss and make plans to stay in each other's lives."],["A boss or manager who is leaving","Thank them for something specific they taught you or made possible, and keep it warm but professional."],["Someone on your team you didn't know well","Keep it short and sincere. A genuine good luck in your next chapter is plenty."],["Signing a group card when you barely knew them","One warm line is fine. Wishing you all the best beats crowding in a joke that isn't yours to make."]]}],
  followUp:"The first weeks in a new place can feel lonely. A short message a month later, just checking how the new chapter is treating them, tells them the friendship did not end at the door.",
  faq:[["What do you write in a farewell card for a coworker?","Something specific and warm: thank them for a way they helped, name what you will miss, and wish them well in their next chapter."],["What is a short goodbye message for a coworker leaving?","Try: It has been a real pleasure working with you. Wishing you all the best in what comes next."],["What should you not write in a coworker's farewell card?","Skip complaints about work, jokes about being forgotten, and leaving only your signature."],["What do you write for a boss or manager who is leaving?","Thank them for something they taught you or made possible, and keep it warm but professional."],["What do you write when you barely know the coworker?","Keep it short and sincere. A simple good luck in your next chapter is genuine and enough."],["Is it okay to be funny in a farewell card?","A light, kind joke works if you know them well. When in doubt, warm and sincere is the safer choice."]],
  related:["what-to-say-for-a-new-job-or-promotion","what-to-write-in-a-retirement-card"],
  },
  {
  slug:"what-to-say-before-surgery", tone:"hard", gesturesHeading:"Ways to steady someone before surgery",
  title:"What to Say to Someone Before Surgery, Without Empty Promises",
  meta:"What to say to someone before surgery: calm, honest words that reassure, what to text, what to skip, and how to show up before and after the operation.",
  h1:"What to say to someone before surgery", begin:"Someone I care about has surgery coming up",
  intro:["The night before a procedure, most people are quietly scared and trying not to show it. What helps is not a promise that everything will go perfectly, because you cannot make that promise. What helps is a steady voice, a little calm, and the sense that someone is in their corner.","Here is what to say, what to leave out, and how to be there before the operation and after it is done."],
  matters:"They are handing their body over to strangers and losing control for a while. Feeling held and thought of makes that easier to carry.",
  say:[["“I'm thinking about you tomorrow, and I'll be waiting to hear how it goes.”","Warm and honest, and it gives them something to count on afterward."],["“You're in good hands, and I'll be right here the whole time.”","Steady and reassuring without promising an outcome you cannot control."],["“You don't have to say anything back. Just know I'm pulling for you.”","Takes the pressure off replying when they have a lot on their mind."],["“Whatever you're feeling before this is completely normal.”","Names the fear without feeding it, so they feel understood."]],
  avoid:[["“You'll be totally fine, don't even worry about it.”","You cannot guarantee that, and it makes real fear feel unwelcome."],["“My cousin had the exact same surgery and it went badly.”","Horror stories are the last thing anyone needs the night before."],["“Everything happens for a reason.”","It lands as cold and dismissive when someone is scared."]],
  gestures:[["Send a short message the morning of","No reply needed, just proof they are on your mind."],["Offer a ride to or from the hospital","Anesthesia means they often cannot drive themselves home."],["Set a reminder to check in after","The scary part is not over when the surgery ends."],["Drop off an easy meal for recovery day","One less thing to figure out while they are worn out."]],
  sections:[{h:"What to say depending on the situation",rows:[["A close friend","Be direct and warm, and keep your normal voice. Tell them you're thinking of them and you'll be waiting to hear."],["A family member waiting during the surgery","Sit with them or check in often. Say “I'm here with you while we wait” and let the quiet be okay."],["A coworker","Keep it brief and low pressure. “Thinking of you, take all the time you need, we've got things covered here.”"],["A parent before their child's surgery","Speak to their fear gently. “This is so hard, and you're doing everything right for them. I'm here for whatever you need.”"],["After it's over","Follow up without prying. “So glad it's behind you. No need to update me, just rest, and I'll check in soon.”"]]}],
  followUp:"Support tends to cluster around the surgery date and vanish during the slow recovery. Put a note in your phone to check in a week later, when the calls have stopped and they're still healing.",
  faq:[["What do you say to someone before surgery?","Something calm and honest, like that you're thinking of them and you'll be waiting to hear how it goes. Reassure them without promising an outcome you cannot control."],["What should you text someone the morning of surgery?","Keep it short and warm, and tell them no reply is needed. Something like “Thinking of you today, you don't have to write back, I'm right here.”"],["What should you not say before an operation?","Skip forced promises that it will all be fine, other people's surgery horror stories, and lines like “everything happens for a reason.”"],["What if I don't know what to say?","You don't need the perfect words. “I don't know quite what to say, but I'm here and I'm thinking of you” is honest and enough."],["How do I support the family waiting during surgery?","Stay near them, check in often, and let the waiting be quiet when it needs to be. Offer to grab coffee or food so they don't have to leave."],["Is it okay to reach out after surgery?","Yes, and it matters. Follow up gently, tell them not to feel any pressure to update you, and offer real help for the recovery days."]],
  related:["what-to-say-to-someone-who-is-sick", "how-to-help-a-friend-with-cancer"],
  },
  {
  slug:"what-to-say-to-someone-who-is-depressed", tone:"hard",
  title:"What to Say to Someone Who Is Depressed",
  meta:"What to say to someone who is depressed: words that support without fixing, what to avoid, and small ways to show up so a struggling friend or family member feels less alone.",
  h1:"What to say to someone who is depressed", begin:"Someone I care about is struggling with depression",
  intro:["Depression is not a bad day you can talk someone out of. It's a heavy fog that can sit on someone for weeks or months, and watching it happen to someone you love can leave you feeling helpless. You don't have to have the right words, and you definitely don't have to fix it. What matters most is that you stay.","Here's how to be a steady presence for someone who is depressed, what tends to help, and the well-meaning things that quietly make it harder."],
  matters:"When someone is depressed, they often already feel like a burden and a failure. What helps most is not advice or encouragement, it's being met without judgment and knowing you're not going anywhere. Presence lands deeper than any pep talk.",
  say:[["“I'm here, and I'm not going anywhere.”","Reassurance that they won't be abandoned matters more than solutions."],["“You don't have to explain it or make sense of it for me.”","Depression is hard to put into words, and being asked to justify it is exhausting."],["“This isn't your fault, and you're not weak for struggling with it.”","Directly counters the shame and self-blame that depression feeds on."],["“What feels doable today, even if it's small?”","Meets them where they are instead of setting a bar they can't reach."]],
  avoid:[["“Just try to think positive.”","It frames a real condition as a choice and adds guilt when they can't."],["“Others have it so much worse.”","Comparisons make them feel wrong for hurting and shut down honesty."],["“Have you tried going for a walk or getting some sun?”","Unasked-for fixes can feel dismissive, as if the problem were simple."]],
  gestures:[["Show up without a reason","Sit with them, watch something, share silence. Presence with no agenda says more than words."],["Take a small task off them","Bring food, wash the dishes, handle one errand. Depression makes ordinary things heavy."],["Keep reaching out","Don't wait for them to reply or reach first. A steady “thinking of you” text asks nothing back."],["Offer one concrete kind of help","Instead of “let me know if you need anything,” say “I'm free Thursday, can I bring dinner over?”"]],
  gesturesHeading:"Small ways to show up",
  sections:[{h:"What to say based on your relationship",rows:[["A close friend","Be the person who keeps showing up without keeping score. Say “I've noticed you've seemed low, and I just want you to know I'm here whenever, no pressure to talk.” Consistency is the gift."],["A family member","History can make this tender, so lead with care over correction. Try “I love you and I'm worried about you, and I'm not here to lecture, only to help.” Avoid slipping into fixing or blame."],["A partner","Live alongside it without making them responsible for your feelings about it. Say “We're in this together and you don't have to carry it alone.” Protect your own footing too, so you can keep showing up."],["When you're worried about their safety","If you sense someone may be in danger of hurting themselves, take it seriously and don't carry it alone. Ask them directly and gently how they're doing, stay with them, and help them reach a professional or a crisis line. This is a moment to bring in real support, not to handle by yourself."]]}],
  followUp:"Depression doesn't lift on a schedule, so the most powerful thing you can do is keep coming back. Check in again next week even if they went quiet, and gently keep the door open to professional support without pushing. Steady beats intense.",
  faq:[["What do you say to someone who is depressed?","Lead with presence and reassurance, not solutions. Something as simple as “I'm here and you don't have to go through this alone” lands better than advice."],["What should you not say to someone with depression?","Skip forced positivity, comparisons, and quick fixes like “just think positive” or “others have it worse.” They add shame and make honesty harder."],["How do you support a friend with depression?","Show up consistently, take small burdens off them, and keep reaching out without needing a reply. Offer concrete help instead of a vague “let me know if you need anything.”"],["Should I encourage them to get professional help?","Yes, gently. You can say you care and that talking to a professional might help, without pressure. You're a support, not a substitute for care."],["What if I say the wrong thing?","Caring presence matters far more than perfect words. Showing up imperfectly beats staying away because you're afraid to get it wrong."],["What if I'm worried they might hurt themselves?","Take it seriously and don't handle it alone. Ask directly how they're doing, stay with them, and help them reach a professional or a crisis line right away."]],
  related:["what-to-say-to-someone-having-a-hard-week","how-to-support-a-friend-from-far-away"],
  },
  {
  slug:"words-of-encouragement-for-a-hard-time", tone:"everyday",
  title:"Words of Encouragement for Someone Going Through a Hard Time",
  meta:"Real words of encouragement for a hard time: uplifting messages that name the hard thing honestly and show belief in the person, without fake positivity.",
  h1:"Words of encouragement for someone going through a hard time",
  begin:"I want to encourage someone going through a hard time",
  intro:["When someone you care about is struggling, it's tempting to reach for something bright and hopeful. But the encouragement that actually lands is the kind that admits things are hard first, and then reminds them who they are.","Here are honest ways to lift someone up without pretending the hard part isn't real."],
  matters:"Encouragement works when the person feels seen, not managed. If they sense you're skipping past the hard thing to get to the silver lining, they stop listening. Name it honestly, then say you believe in them.",
  say:[["“This is a lot, and you're still standing. That says something about you.”","Names the weight and the strength in the same breath."],["“I've watched you get through hard things before, and I believe you'll find your way through this too.”","Belief grounded in their real history, not a slogan."],["“You don't have to figure it all out today. I'm not going anywhere.”","Takes the pressure off and offers steadiness."],["“Whatever happens, you're not doing this alone.”","The most encouraging thing is often company, not a pep talk."]],
  avoid:[["“Everything happens for a reason.”","It asks them to be grateful for pain they're still in."],["“Just stay positive.”","It makes their honest feelings sound like a failure."],["“You've got this!”","Cheerful and empty; it can feel like you didn't really hear them."]],
  gestures:[["Remind them of a past win","Point to a specific hard thing they already got through."],["Show up small and often","A short check-in beats one big speech."],["Say the belief out loud","Tell them plainly that you're rooting for them and mean it."],["Offer your steadiness","Let them know you'll still be here when it's not resolved."]],
  gesturesHeading:"Ways to encourage that actually help",
  sections:[{h:"Encouragement for different moments",rows:[["Someone facing a big challenge","“It's okay to be nervous. That doesn't mean you're not ready.”"],["Someone who is exhausted and discouraged","“You don't have to be strong right now. Just rest, I've got you.”"],["Someone who failed at something","“This didn't work out, and it doesn't erase what you're capable of.”"],["Someone in a long hard stretch","“I know this has gone on a long time. I'm still right here with you.”"]]}],
  followUp:"Encouragement means more when it repeats. Check back in a few days with “still in your corner, how are you holding up?” so they know you didn't say it once and move on.",
  faq:[["What are good words of encouragement for a hard time?","Name the hard thing honestly, then express real belief in the person. Something like “this is a lot, and I've seen you get through hard things before.” Skip the slogans."],["How do I encourage someone without sounding fake?","Be specific and honest. Mention the actual struggle instead of a generic “stay positive,” and point to something real you believe about them."],["What should I not say when trying to encourage someone?","Avoid “everything happens for a reason,” “it could be worse,” and “just stay positive.” They minimize what the person is feeling."],["What if I don't know what to say?","Say that. “I don't have the right words, but I'm here and I care about you” is more encouraging than a polished line that misses."],["Do encouraging messages actually help?","Yes, when they make the person feel seen rather than fixed. Being reminded they're not alone and that someone believes in them can lighten the weight."],["How often should I check in?","More than once. A short, low-pressure message every few days shows steady support without asking them to perform being okay."]],
  related:["what-to-say-to-someone-having-a-hard-week","ways-to-thank-someone-who-is-always-there"],
  },
  {
  slug:"what-to-say-when-a-friend-moves-away", tone:"everyday",
  title:"What to Say When a Friend Moves Away: Warm Goodbyes",
  meta:"What to say when a friend moves away: honest, bittersweet words to say goodbye and promise to keep the friendship alive across the distance.",
  h1:"What to say when a friend moves away",
  begin:"A close friend is moving away",
  intro:["A friend moving away is one of those goodbyes that holds two things at once. You are genuinely happy for the road ahead of them, and you are quietly bracing for how much you will miss the ordinary days you shared.","You do not have to hide either feeling. The warmest goodbye names what they have meant to you and makes a real promise to keep the friendship going, distance and all."],
  matters:"The goodbye that lands is <em>specific and honest</em>: it says what they have meant to you and treats the friendship as something that continues, not something that ends at the county line.",
  say:[["“I am so happy for you, and I am going to miss you more than I can say.”","Holding both feelings at once is what makes it ring true."],["“You have been the person I call when <em>[specific thing]</em>, and that does not stop just because you moved.”","Naming what they have been to you makes it real."],["“This is not goodbye, it is just a longer drive between us.”","Reframing the goodbye as a change, not an ending, is a small comfort that carries."],["“I already know the first thing I want to tell you when we talk next week.”","A promise of the next conversation keeps the door wide open."]],
  avoid:[["A flat “good luck, keep in touch”","It sounds like the door closing. Say something only you would say to them."],["Making your sadness their burden","You can be honest about missing them without asking them to feel guilty for going."],["Pretending nothing is changing","Naming the loss honestly is what lets the warmth land."]],
  gestures:[["Write it by hand","A card they can keep says more than a text they will scroll past."],["Give them a last ordinary day","Not a big send-off, just the coffee or the walk you always did together."],["Send something for the new place","A small thing that says you are thinking of them where they are now."],["Put the next call on the calendar before they leave","A real date means the friendship has a next chapter, not just good intentions."]],
  gesturesHeading:"Ways to show it",
  sections:[{h:"What to say depending on the goodbye",rows:[["A best friend moving far","Be fully honest: “You are my person, and no distance changes that.” Then make a concrete plan to stay close so the words have something to stand on."],["A friend moving for a happy reason (a job, love)","Lead with real gladness for them: “This is exactly what you have worked for.” Let your pride in them be louder than your missing them, and save the missing for a quieter moment."],["A friend you will rarely see","Be gentle and realistic: “I know we will not talk every day, but you matter to me and I am not letting this fade.” Name the friendship as worth keeping even if it looks different now."],["What to write in a going-away card","Keep it warm and specific: one memory that sums them up, one line about what they have meant to you, and one promise about staying in touch. Short and true beats long and general."]]}],
  followUp:"The goodbye is only the start. What keeps a friendship alive is the text weeks later, the call you actually make, the way you keep showing up from far away.",
  faq:[["What do you say when a friend moves away?","Say what they have meant to you and that the friendship continues. Something like “I am so happy for you and I am going to miss you, and this is not goodbye, just more miles between us.”"],["What should I write in a going-away card?","One specific memory, one line about what they have meant to you, and one promise to stay in touch. Specific and short reads warmer than long and general."],["How do I say goodbye without making it sad?","Hold both feelings. Let your happiness for them lead, be honest that you will miss them, and end on the next time you will talk so it feels like a pause, not an ending."],["What do you say to a friend moving away for a job or a partner?","Lead with pride in them: “This is exactly what you have worked for.” Your gladness for them should be louder than your own sadness in the moment of goodbye."],["How do you stay close to a friend who moved away?","Make the next contact concrete before they leave, then keep it. A standing call, a shared show, a habit of small texts turns distance into something the friendship survives easily."],["Is it okay to tell them I will miss them?","Yes. Honesty is the warmth. Just say it as love, not as guilt, so they can carry it with them instead of feeling bad for going."]],
  related:["how-to-support-a-friend-from-far-away","ways-to-thank-someone-who-is-always-there"],
  },
  {
  slug:"what-to-write-in-a-congratulations-card", tone:"celebration",
  title:"What to Write in a Congratulations Card",
  meta:"Meaningful things to write in a congratulations card for any win: messages that name the effort behind the achievement, what to avoid, and thoughtful ways to celebrate.",
  h1:"What to write in a congratulations card", begin:"Someone I know has great news and I want to congratulate them",
  intro:["It is easy to reach for a quick “congrats!” and call it done. But a real congratulations names what they did and matches how big this feels to them.","Here is how to write a note that lands as more than a reflex, whatever the win is."],
  matters:"The best congratulations show you noticed the work behind the win, not just the win itself.",
  say:[["“I know how hard you worked for this, and it could not have happened to a better person.”","Names the effort, not just the result."],["“I have been rooting for you the whole way, and I am so proud of you.”","Tells them their win mattered to you too."],["“This is exactly what you deserve. Go celebrate.”","Warm, sure, and gives them permission to enjoy it."],["“I cannot stop smiling about your news.”","Matches their joy instead of staying flat and polite."]],
  avoid:[["“Congrats! Now the real work begins.”","Deflates the moment right when they want to enjoy it."],["“Must be nice.”","Turns their win into a comment about you."],["Just “Congratulations” and nothing else","Reads like you signed without reading."]],
  gestures:[["A call or voice note","Your actual voice carries excitement a card cannot."],["A small treat to celebrate","Turns the news into a moment they mark."],["A specific line about what impressed you","Shows you saw the person, not just the headline."]],
  gesturesHeading:"Ways to make it land",
  sections:[{h:"What to write for different wins",rows:[["A big thing they worked hard for","Name the effort and the wait. Tell them you saw what it took."],["Good news that surprised them","Match their delight and let yourself sound happily caught off guard too."],["A milestone at school, work, or in life","Mark how far they have come, not just the title or the date."],["A close friend","Be personal and a little unfiltered. Let the pride show."],["Someone you do not know well","Keep it warm and genuine without forcing closeness you do not have."]]}],
  followUp:"Ask about it again a week later. “So how did it feel once it sank in?” tells them the news stayed with you.",
  faq:[["What do you write in a congratulations card?","Go past “congrats” by naming what they did to earn it and how happy you are for them. A specific line about their effort means more than any quote."],["How do you congratulate someone genuinely?","Match their level of joy and mention the work behind the win. Genuine congratulations sound like you were paying attention, not signing off a list."],["What should you not write in a congratulations card?","Skip anything that shrinks the moment, like warning them about what comes next or making it about you. Save the advice and just celebrate."],["What is a short congratulations message?","“So proud of you, and so happy this worked out” is short and real. Add one detail about their specific win and it stops sounding generic."],["Is it okay to send congratulations late?","Yes. A note that says you only just heard and could not not reach out is still welcome, and often a nice surprise after the rush."]],
  related:["what-to-say-for-a-new-job-or-promotion","what-to-write-in-a-graduation-card","what-to-say-when-someone-gets-engaged"],
  },
  {
  slug:"what-to-say-when-someone-doesnt-get-the-job", tone:"hard",
  title:"What to Say When Someone Doesn't Get the Job",
  meta:"Comforting things to say when someone doesn't get the job or gets turned down for something they wanted, plus what to avoid and real ways to show up.",
  h1:"What to say when someone doesn't get the job", begin:"A friend just found out they didn't get the job",
  intro:["They got their hopes up, and the answer was no. You want to make it better, and the pull to reach for a bright side is strong. Sit in the letdown with them first. That is what actually helps.","Here's what lands as real support, what tends to sting even when you mean well, and how to keep showing up after."],
  matters:"They wanted this, and they didn't get it, and that is worth being sad about. Before any pep talk or plan, they need to feel that you get how much it stung. Belief in them means more than advice right now.",
  say:[["“That's a real letdown. You wanted this one.”","Names the disappointment instead of rushing past it."],["“You put yourself out there, and that took guts.”","Honors the effort separate from the outcome."],["“I still think the world of what you can do.”","Steady belief, no lecture attached."],["“Do you want to be mad about it, or think about what's next?”","Lets them pick the moment for problem-solving."]],
  avoid:[["“Everything happens for a reason.”","Asks them to feel okay before they're ready."],["“Their loss, honestly.”","Skips past the hurt to defend them."],["“On to the next one.”","Rushes them out of a feeling they're still in."]],
  gestures:[["Follow up a few days later","Let them know you didn't forget the thing they wanted."],["Do something ordinary together","A meal or a walk keeps them company without making it heavy."],["Offer help only if they want it","A read on the interview or a warm intro, but only after you've listened first."],["Remind them of a past win","Point to a time they came through, no moral attached."]],
  gesturesHeading:"Ways to show up",
  sections:[{h:"What to say for different letdowns",rows:[["A job or promotion they wanted","Name that they earned the shot even if the answer was no, and let them be frustrated before talking next steps."],["A school or program rejection","Sit with the sting of a door closing, and don't rush to line up the backups."],["A friend who keeps getting knocked back","Acknowledge how tiring the string of no's is, and remind them you're still in their corner."],["When they're blaming themselves","Push back gently on the harsh story, and point to what was outside their control."]]}],
  followUp:"The sting lasts longer than the sympathy. A week or two later, check back in with a simple note that you're still thinking of them, no agenda.",
  faq:[["What do you say when someone doesn't get the job?","Name the disappointment first, honor the effort it took to try, and tell them you still believe in them. Save advice for when they ask."],["Should I tell them it's the company's loss?","Not as a first response. It can feel like you're skipping past their hurt to defend them. Let them be disappointed before you reframe it."],["What should I avoid saying?","Skip “everything happens for a reason” and “on to the next one.” Both rush them out of a feeling they're still sitting in."],["How do I help without giving unwanted advice?","Ask what they need before offering it. Say something like “do you want to vent, or do you want help thinking it through?” and follow their answer."],["What if they keep getting rejected?","Acknowledge how draining the repeated no's are, keep reminding them you're in their corner, and don't turn every talk into a fix-it session."],["When is it okay to talk about next steps?","When they bring it up, or when you've asked and they say they're ready. Let the disappointment breathe first."]],
  related:["what-to-say-when-someone-loses-their-job", "what-to-say-to-someone-having-a-hard-week"],
  },

  // ---- Batch 7 (TC-175 seasonal wave): calendar/seasonal intent pages ----
  { slug:"what-to-write-in-a-mothers-day-card", tone:"celebration", title:"What to Write in a Mother's Day Card", meta:"Warm, non-cliché ideas for what to write in a Mother's Day card, whether it is for your own mom, a new mom, a grandmother, a mother figure, or someone having a hard year.", h1:"What to write in a Mother's Day card", begin:"It is almost Mother's Day and I want to write something meaningful", intro:["Mother's Day cards tend to fill up with the same soft words, and the person reading yours can usually tell when the line came from the card and not from you.","Here is what to write, what to skip, and how to make it sound like it actually came from you, even if your relationship is complicated."], matters:"The line she rereads is the one that names something real about <em>her</em>, not motherhood in general.", say:[["“Thank you for the things you did that I only understand now that I am older.”","Names growth without pretending it was all easy."],["“I hope you know how much of the good in me came from you.”","Credits her without sounding like a greeting card."],["“You showed up for me in ways I do not always say out loud, so I am saying it now.”","Turns a card into an actual acknowledgment."],["“Being your kid taught me what it looks like to keep showing up.”","Specific and quietly proud."]], avoid:[["“Best mom ever!”","It is a ranking, not a feeling, and it says nothing only you could say."],["“Happy Mother's Day!” with just a signature","The blank card said that already."],["“You do so much for everyone.”","True of many people and specific to none."]], gestures:[["Name one thing she did for you","A single real memory beats a page of praise."],["Thank her for something you get only now","Grown-up gratitude lands harder than childhood sweetness."],["Say the thing you assume she knows","She probably does not hear it as often as you think."],["Offer time, not just words","Tell her you want to call or come by, then do it."]], gesturesHeading:"Small ways to make it land", sections:[{h:"What to write depending on your relationship",rows:[["Your own mom","Pick one real memory or one thing you understand now that you did not as a kid, and build the note around it."],["A new mom","Reassure more than you praise. Tell her she is already doing it well and that she is allowed to be tired."],["A grandmother","Thank her for the steadiness and the stories, and name something specific she passed down."],["A mother figure or someone who mothered you","Be direct that she filled a role no one asked her to, and that it mattered. Do not soften it into nothing."],["A mom going through a hard year","Skip the bright cheer. Acknowledge that this year has been heavy and that you see her carrying it, and leave it there."]]}], followUp:"Mother's Day can be tender for reasons a card cannot fix. If the day is hard for her, a quiet check-in a few days later often means more than the card did.", faq:[["What do you write in a Mother's Day card?","Name one specific thing: a memory, a trait you inherited, or something she did that you appreciate more now. Skip the ranking words like best or greatest."],["What can I write if my relationship with my mom is complicated?","Be honest but kind. You can thank her for one real thing without pretending everything was perfect. A true, narrow line beats a warm, false one."],["What do you write for a mother figure who is not your mom?","Say plainly that she stepped into a role no one required of her and that it shaped you. Naming it directly is the whole point."],["What should I write for a new mom on Mother's Day?","Reassure her. Tell her she is doing better than she feels like she is, and that being tired does not mean she is failing."],["What do I write for someone whose Mother's Day is hard this year?","Acknowledge the weight instead of covering it with cheer. Something like knowing this year is heavy and that you are thinking of her is enough."],["Is it okay to keep a Mother's Day note short?","Yes. One honest, specific sentence is worth more than a full card of soft words she has read before."]], related:["what-to-write-in-a-birthday-card","ways-to-thank-someone-who-is-always-there","what-to-write-in-a-congratulations-card"] },
  { slug:"what-to-write-in-a-fathers-day-card", tone:"celebration", title:"What to Write in a Father's Day Card", meta:"Warm, real ideas for what to write in a Father's Day card, whether it's for your own dad, a new dad, a grandfather, a father figure, or a dad you have a complicated history with. Skip the joke card and say the thing that lands.", h1:"What to write in a Father's Day card", begin:"Father's Day is coming and I want to write something real, not just sign my name under a joke.", intro:["A lot of dads spend the day getting golf jokes and cartoons of recliners, and never hear the plain truth of what they mean to someone. That's exactly why a genuine line hits so hard here.","Below are lines you can actually write, a few to skip, and ways to match your words to the kind of dad you're writing to."], matters:"Many men rarely hear heartfelt words out loud, so a card that says <em>why</em> he matters can land harder than you'd expect. That plain sentence is the part he keeps.", say:[["“I hope you know how much I look up to you.”","Simple, and the kind of thing dads rarely get told."],["“Thank you for the things you did that I only understand now.”","Names the quiet, unglamorous work of being a dad."],["“I turned out okay, and a lot of that is you.”","Credit where it's due, without going overboard."],["“I'm proud to be yours.”","Short, warm, and hard to read without feeling it."]], avoid:[["“Happy Father's Day to the best dad ever!”","Fine on the front of the card, but it can't be the whole message."],["“Thanks for everything.”","Everything is nothing in particular. Name one real thing."],["“Here's to another year, old man.”","The joke is easy, but it lets you off the hook from saying anything true."]], gestures:[["Name one thing he taught you","A skill, a saying, a way of handling trouble. It shows the lesson stuck."],["Point to who you became","Tell him a trait of yours that came from him. That closes the loop."],["Say the thing you assume he knows","He may not. Write it down where he can reread it."],["Give him the day, not just the card","Offer time together, a call, a meal. The card starts it, the time finishes it."]], gesturesHeading:"Small ways to make it land", sections:[{h:"What to write depending on your relationship",rows:[["Your own dad","Get specific about one thing he did or taught you. He has heard the generic version already, so give him the real one."],["A new dad","Tell him you already see him showing up. Early days are exhausting and mostly unwitnessed, and being noticed means a lot."],["A grandfather","Thank him for the steadiness. Grandkids and grown kids alike remember a grandfather who was simply, reliably there."],["A father figure or stepdad","Name that he chose this. He stepped into a role no one required of him, and saying so out loud matters."],["A dad you have a complicated history with","Keep it honest and small. You can write “I'm thinking of you today” or “I hope you're well” without pretending things are simpler than they are. A true, gentle line beats a warm one you don't mean."]]}], followUp:"If you can, call him or sit with him on the day too. The card opens the door, and your voice walks through it.", faq:[["What should I write in a Father's Day card?","Write one specific, honest sentence about what he did or who he is, then thank him for it. One real line beats a page of general praise."],["What do you say to a dad who is hard to buy a card for?","Skip the joke cards and say a plain true thing. “I appreciate you” or “I'm glad you're my dad” is worth more than a clever punchline he'll forget."],["What can I write for a father figure or stepdad?","Acknowledge that he chose to show up. Something like “You didn't have to be there for me, and you were” names exactly what makes him special."],["What do I write if our relationship is complicated?","Stay honest and low-pressure. “Thinking of you today” or “I hope you're doing well” is kind and true without claiming a closeness that isn't there."],["How do I make it not sound like a greeting card?","Use your own plain words and one specific memory. If it sounds like something only you could have written to only him, you've got it."],["What if I'm not good with words?","Short is fine. “Thank you for everything you taught me. I'm proud to be your kid.” Two honest sentences are plenty."]], related:["what-to-write-in-a-mothers-day-card","ways-to-thank-someone-who-is-always-there","what-to-write-in-a-birthday-card"] },
  { slug:"what-to-write-in-a-valentines-day-card", tone:"celebration", title:"What to Write in a Valentine's Day Card", meta:"Warm, specific things to write in a Valentine's Day card, whether it goes to a partner, a new flame, a friend, or family. Real lines to say and clichés to skip.", h1:"What to write in a Valentine's Day card", begin:"I want to write a Valentine's card that doesn't sound like a greeting card", intro:["Valentine's Day gets a bad reputation for being scripted. The pink foil, the rhyming verse, the same three words everyone reaches for. But a card someone keeps is almost never the fancy one. It's the one where you sounded like yourself.","The trick is to name something real about this person or this year, and to match the size of your words to the size of what's actually there. Below are lines to borrow, traps to skip, and a guide for who you're writing to."], matters:"A good Valentine names <em>this</em> person, not the holiday. The more specific you are, the less it reads like a card and the more it reads like you.", say:[["“You are my favorite ordinary day.”","Says the love lives in the everyday, not the grand gesture."],["“I keep being glad it's you.”","Quiet, present-tense, and true across any number of years."],["(New) “I like where this is going, and I like going there with you.”","Warm without over-declaring. Reads as glad, not heavy."],["(Friend) “Every good thing is more fun because you're in on it.”","Lands for a friend or family Valentine with zero romance required."]], avoid:[["“Roses are red, violets are blue...”","The second everyone knows the rhyme, they stop reading. Say the real thing instead."],["“You complete me.”","It asks the card to carry more than it can. Name one true thing you'd rather."],["(New relationship) “You're my soulmate, my forever, my everything.”","Too much, too soon reads as pressure, not romance. Keep it light and let the year earn the big words."]], gestures:[["Point to one specific moment","Instead of “I love you,” try “I loved the way you handled that hard week.” One real memory outweighs a page of adjectives."],["Write it by hand, even if it's short","Three handwritten lines beat a paragraph you typed. The handwriting is half the gift."],["Say what you're looking forward to","A Valentine can point forward, not just back. Name one thing you're glad is still ahead of you both."],["Leave the holiday out of it","You can skip the word “Valentine” entirely and just tell someone they matter. Sometimes that reads warmer."]], gesturesHeading:"Small ways to make it land", sections:[{h:"What to write depending on the relationship", rows:[["A long-term partner or spouse","You don't need to prove anything, so don't perform. Name one small, current thing you still love, the way they make coffee, how they are late at night. Familiarity is the romance here."],["A new relationship (keep it light)","Say you're glad and curious, not that you've found forever. “I'm really happy you're my Valentine this year” is plenty. Let the words stay a size smaller than the feelings so nothing feels rushed."],["A friend (galentine's or palentine's)","Drop the romance and keep the affection. Tell them they're a person you'd pick again, that your life is better with them in it. Warm and a little funny beats sappy."],["A kid or family member","Simple and sincere. “I'm so lucky I get to be your person” works for a child, a parent, a sibling. Skip the mush and just tell them they're loved."]]}], followUp:"The card is one day. Following through the rest of the year, the small “thinking of you” on a random Tuesday, is what the card was really promising.", faq:[["What should I write in a Valentine's card?","Name one specific, true thing about this person, then match your words to how close you actually are. Skip the rhyme and say what you'd say out loud."],["What do you write to someone you just started dating?","Keep it light and glad. Something like “Happy I get to be your Valentine this year” says plenty. Save the big declarations for when the year has earned them."],["What can I write if my Valentine isn't romantic?","Plenty of Valentines go to friends, kids, and parents. Just tell them they matter to you and your life is better with them in it. No romance required."],["Is it corny to send a Valentine's card?","Only if you use someone else's words. A card in your own voice, naming something real, never reads as corny. It reads as thoughtful."],["What should I avoid writing?","Skip the tired rhymes and the lines that promise more than the moment holds, like “you're my everything” to someone you've dated for a month. Specific and honest always wins."]], related:["what-to-write-in-an-anniversary-card","what-to-write-in-a-birthday-card","ways-to-thank-someone-who-is-always-there"] },
  { slug:"what-to-write-in-a-christmas-card", tone:"celebration", title:"What to Write in a Christmas Card (One Line That Feels Personal)", meta:"Warm, specific ideas for what to write in a Christmas card, so each one sounds like you and not the printed message inside. Lines for family, coworkers, and someone missing home.", h1:"What to write in a Christmas card", begin:"I'm writing my Christmas cards and want them to feel personal", intro:["A stack of Christmas cards can start to feel like a chore, and it shows. The printed message does the talking, the signature does the rest, and the card blurs in with all the others.","The fix is small. One specific line for each person, something only you would say to them, turns a mass mailing back into a note. Here's how to find that line."], matters:"A Christmas card is one of the few times a year you reach out for no reason except to say you were thinking of them. The words are the whole point, so make them <em>land</em>.", say:[["“Every time I hear that one song from the mall this year I think of the road trip we took. Merry Christmas, friend.”","Ties the season to a real memory you share."],["“This is the year you moved into your first place, and I hope it feels like home by now. Happy holidays.”","Names something that actually happened to them."],["“I still laugh about the burnt cookies from last December. Wishing you a warm, safe holiday.”","A small inside moment beats a generic wish every time."],["“You've been on my mind more than these cards let on. Thinking of you this season.”","Honest and unhurried, which reads as real."]], avoid:[["“Happy holidays to you and yours!”","Fine as a closer, empty as the whole message."],["“Hope this finds you well.”","Sounds like the start of a form letter."],["“Wishing you all the best in the new year!”","True for everyone, meant for no one."]], gestures:[["Write the specific line first","Start with the memory, then add the season's wishes around it, not the other way around."],["Sign it by hand","Even a printed card feels personal once your own handwriting is on it."],["Mail a few early","The ones that arrive before the rush get actually read, not stacked."],["Add one line about the year ahead","A small hope for their next year shows you're still paying attention."]], gesturesHeading:"Small things that make a card feel personal", sections:[{h:"What to write for different people", rows:[["Close family and friends","Write the way you talk to them. Name a moment from this year, an inside joke, or something you're looking forward to doing together. This is the one place to be soft and say the quiet thing out loud."],["A coworker or client","Keep it warm, brief, and open to everyone, since not all of them celebrate Christmas. Try “Wishing you a restful holiday season and a good year ahead,” and add one genuine line about working together this year."],["Someone far away you miss","Say the distance out loud. “The miles feel longer this time of year” or “Wish we were closer so I could see you” tells them the gap is on your mind too, which is often the whole gift."],["Someone having a hard holiday season","Skip the forced cheer. Grief and loneliness get heavier in December, so name it gently: “I know this season looks different this year. I'm thinking of you, and I'm here.” Presence beats brightness."]]}], followUp:"A card is a lovely start. If someone came to mind while you wrote it, that's worth a call or a visit sometime after the holidays too.", faq:[["What should you write in a Christmas card?","One specific line only you would say to that person, wrapped in a warm seasonal wish. Name a shared memory, something from their year, or a small hope for the next one."],["What's a good short Christmas card message?","“Thinking of you this season and grateful you're in my life. Merry Christmas.” Short works as long as it sounds like you and not the printed line above it."],["What do you write in a work Christmas card?","Keep it inclusive and warm. “Wishing you a restful holiday season and a strong year ahead” works for anyone, plus one honest line about the year you shared."],["What do you write to someone spending the holidays alone or grieving?","Name it gently and offer presence, not cheer: “I know this season is heavy this year. I'm thinking of you, and I'm here whenever you want company.”"],["How do you make a Christmas card feel personal?","Add one line no one else could have written, sign it by hand, and mention a real moment from your year together rather than a general wish."],["What should you not write in a Christmas card?","Skip the fill-in-the-blank lines like “hope this finds you well” or “all the best in the new year.” They're true for everyone and remembered by no one."]], related:["what-to-write-in-a-birthday-card","what-to-write-in-a-thank-you-card","ways-to-thank-someone-who-is-always-there"] },
  { slug:"what-to-say-youre-thankful-for-someone", tone:"everyday", title:"What to Say When You're Thankful for Someone", meta:"How to tell someone you're thankful for them, at Thanksgiving or any time gratitude is the point.", h1:"What to say when you're thankful for someone", begin:"I want to tell someone I'm thankful for them this Thanksgiving", intro:["Thanksgiving is one of the few times we're actually invited to say who we're grateful for, and most of us still let the moment pass.","Telling a person directly that you're thankful for them is rare, and that's exactly what makes it land. Here's how to say it so it feels real, not like a toast nobody remembers."], matters:"Being thankful <em>for a person</em> is different from being thankful for what they did. Say the person out loud, and they'll carry it far longer than any gift.", say:[["“I don't think I've ever told you this, but I'm really thankful for you.”","Naming that you've never said it makes the moment matter more."],["“When I count what I'm grateful for this year, you're near the top of the list.”","Ties the holiday feeling to them specifically."],["“You've made this year easier just by being around, and I don't take that for granted.”","Points at their steady presence, not one big favor."],["“I'm thankful for the way you <em>[specific thing they do]</em>. It means more than you know.”","One real detail proves you mean it."]], avoid:[["“Thankful for family and friends.”","Say the actual person, not the category."],["Waiting for the perfect toast in front of everyone","A quiet, direct word usually lands harder than a speech."],["Adding a joke to soften it","The joke gives you an exit. Let the sincere part stand on its own."]], gestures:[["Say it before the meal, quietly","A word at the sink or in the car beats a public toast for most people."],["Put it in a short note","Slip it by their plate or text it the morning after. Written words get re-read."],["Tell them what they'd never guess","Name the small thing they don't think you noticed."],["Say it again next year","Gratitude that comes back around is the kind people believe."]], gesturesHeading:"Ways to say it", sections:[{h:"How to say it to different people",rows:[["A parent or family member","“I'm thankful for you” lands hard here because they rarely hear it from you. Add one thing they did that shaped you."],["A friend","Keep it plain and warm: you're glad they're in your life, and this year showed you why."],["A partner","Thank them for the ordinary days, not just the big moments. Steadiness is the gift you notice least and miss most."],["A mentor or someone who helped you this year","Be specific about the door they opened or the advice that stuck. People who help rarely learn whether it mattered."]]}], followUp:"You don't need a holiday for this. The next time someone crosses your mind with a warm feeling, that's the moment to tell them.", faq:[["How do I tell someone I'm thankful for them without it feeling awkward?","Keep it short and specific, and say it in a low-key moment rather than in front of a crowd. One honest sentence is enough."],["What's a good Thanksgiving message for a friend or family member?","Name the person, not the category. Try: “When I think about what I'm grateful for this year, you're on the list.” Then add one real detail."],["Is it better to say it out loud or write it down?","Both work. Out loud feels immediate; a note gets re-read for years. If saying it makes you freeze up, write it."],["Do I have to wait for Thanksgiving?","No. Gratitude aimed at a person lands any time, and it's often more powerful when there's no occasion prompting it."],["What if they get uncomfortable or brush it off?","That's usually surprise, not rejection. Say your piece, don't over-explain, and let it sit. They'll remember it."],["How do I make it sound genuine and not like a card?","Trade the general phrase for one specific thing they do. Specificity is what separates a real thank-you from a greeting."]], related:["ways-to-thank-someone-who-is-always-there","what-to-write-in-a-thank-you-card","what-to-write-in-a-christmas-card"] },
  { slug:"what-to-say-on-mothers-day-to-someone-who-lost-their-mom", tone:"hard", gesturesHeading:"Ways to show up on the day", title:"What to Say on Mother's Day to Someone Who Lost Their Mom", meta:"Kind, grounded things to say to a grieving friend on Mother's Day, and what to avoid.", h1:"What to say on Mother's Day to someone who lost their mom", begin:"Mother's Day is coming and my friend lost their mom", intro:["Mother's Day can be one of the loneliest days of the year for someone whose mother is gone. Everywhere they look there are cards, flowers, and brunches, and the one person the day is about is the one they can't reach. Reaching out is a real kindness.","Here is what tends to help, what to avoid, and a few ways to let them know the day is on your mind too."], matters:"On a day the whole world spends celebrating mothers, a grieving person's deepest fear is that theirs has been forgotten. Naming her, and remembering with them, is the gift.", say:[["“I'm thinking of you this Mother's Day, and I'm remembering <em>[mom's name]</em> with you.”","Naming her mother proves she hasn't been forgotten."],["“This day is a hard one. No need to reply, I just wanted you to know I'm here.”","Names the day honestly and lifts any pressure to perform."],["“I still remember how she <em>[specific memory]</em>. I think about her.”","A shared memory tells them her life still lives on in someone else."],["“However today lands for you, I've got you. Want company, or space?”","Offers presence without assuming what they need."]], avoid:[["“At least you had so many good years with her.”","Anything that starts with 'at least' minimizes what they lost."],["“She's in a better place now.”","It answers a grief they didn't voice and can land as a dismissal."],["Saying nothing so you don't 'remind' them","They haven't forgotten for a second. Silence reads as no one remembering her at all."]], gestures:[["Say her mother's name","The simplest and most meaningful thing you can do. Use it out loud."],["Share a memory or photo","A story or picture they haven't seen is a piece of their mom handed back to them."],["Check in the day before or after too","The whole weekend can ache. A quiet message on either side says you're really paying attention."],["Do something small in her honor","Light a candle, cook her recipe, or give to a cause she loved, and tell your friend you did."]], sections:[{h:"What to say based on the situation",rows:[["A friend whose mom died recently","This is likely their first Mother's Day without her, and it will be raw. Keep it gentle and specific: 'I'm thinking of you and remembering <em>[name]</em> today. I'm here all weekend if you want anything at all.' Expect little back, and mean it when you say no reply is needed."],["Someone years out for whom the day still stings","Time doesn't retire this day. That they seem 'fine' most of the year makes remembering now matter more. 'It's been a while, and I know today can still catch you. Thinking of your mom and of you.' Being the one who still remembers is rare and precious."],["Someone who is a mother herself and grieving her mom","The day pulls in two directions: she's being celebrated as a mom while missing her own. Honor both. 'Happy Mother's Day to you, and I'm holding <em>[name]</em> in my heart with you today.' Let her be celebrated and bereaved at once, without choosing."],["A mom who lost a child (the day cuts the other way)","For a bereaved mother, this day can be its own wound. Don't skip her because it's complicated. 'You are <em>[child's name]</em>'s mom today and always, and I'm thinking of you both.' Naming her child, and her as their mother, is everything."]]}], followUp:"Grief doesn't end when the day does. A short note a few days later, with her mom's name in it, tells your friend you didn't just remember once. That steadiness is a lasting kindness.", faq:[["What do you say on Mother's Day to someone who lost their mom?","Tell them you're thinking of them and say their mother's name. 'I'm remembering <em>[name]</em> with you today' does more than any long message."],["Should I mention their mom, or will that upset them?","Mention her. They haven't forgotten, so you won't be reminding them of anything. Hearing her name is usually a comfort, not a fresh wound."],["What should I avoid saying?","Skip anything that begins with 'at least,' anything about a 'better place,' and any attempt to find a bright side. Presence beats silver linings."],["Is it better to say nothing so I don't make them sad?","No. Silence tends to feel like their loss doesn't matter to anyone. A simple 'thinking of you today' is almost always welcome."],["What if I don't know what to say?","Say exactly that: 'I don't have the right words, but I'm thinking of you and your mom today.' Honesty lands better than a perfect line."],["How do I support a grieving mother on Mother's Day?","Acknowledge her as a mother and name her child. Let her be both celebrated and grieving, and don't wait for her to reach out first."]], related:["what-to-say-when-someone-loses-a-parent","how-to-honor-someone-on-a-loss-anniversary","ways-to-help-a-grieving-friend"] },
  { slug:"what-to-write-in-a-new-year-message", tone:"celebration", title:"What to Write in a New Year Message", meta:"Warm, real things to write in a New Year message to someone you care about.", h1:"What to write in a New Year message", begin:"I want to send a New Year message that isn't just 'Happy New Year'", intro:["A blank New Year note can feel oddly hard. You want to say something warmer than the same three words everyone sends, but resolution talk feels hollow and hallmark-y.","The move is to look back at the year with the person, then forward, and let them feel that you were paying attention the whole time."], matters:"A New Year message lands when it reflects on the year you shared and looks ahead with warmth, instead of reaching for a generic wish.", say:[["“Grateful you were part of my year. Here is to more of you in the next one.”","Names the relationship, not just the calendar flip."],["“Whatever this year held for you, I am glad we are walking into the new one together.”","Acknowledges the real year, good or hard."],["“Thinking back on the year, so many of my favorite moments have you in them.”","Specific warmth beats a blanket wish."],["“May this year be gentler, brighter, and full of the good stuff you deserve.”","A wish that feels personal, not like a slogan."]], avoid:[["“New year, new you!”","Implies the old them needed fixing."],["“This is finally your year to get it together.”","Reads as a jab dressed up as encouragement."],["Only “Happy New Year” with nothing else","Fine for an acquaintance, thin for someone who matters."]], gestures:[["A short voice note at midnight or the morning after","Your voice carries the warmth a text flattens."],["Name one good memory from the year","Tell them the moment with them you are still thinking about."],["A first-week-of-January check-in","Reaching out after the noise dies down means more than a group text."],["Suggest one thing to look forward to together","A plan to see each other turns a wish into something real."]], sections:[{h:"What to write for different people",rows:[["A close friend or family member","Be personal and specific. Name a moment from the year and say you are glad they are yours going into the next one."],["A partner","Speak to the year you built together and the one ahead. Something like, “Every year with you is my favorite one yet.”"],["A coworker or client","Keep it warm but light. Thank them for the year of working together and wish them a good one ahead, no oversharing."],["Someone who had a hard year","Skip the forced cheer. Try, “This year asked a lot of you. I hope the new one gives some of it back. I am in your corner.” A fresh start, not a demand to be okay."]]}], followUp:"Circle back in mid-January to ask how their year is actually starting, once the resolutions crowd has gone quiet.", faq:[["What do you write in a New Year message?","Reflect on the year you shared, then wish them well ahead. Name something specific so it does not read like a mass text."],["What is a short New Year message?","Try, “Grateful for you this year. Here is to a good one ahead.” Short is fine when it is sincere."],["What can I say instead of just Happy New Year?","Name the relationship or a memory: “So glad I got to share this year with you.” It turns a reflex into a real note."],["What do you write to someone who had a rough year?","Acknowledge it honestly and offer a gentle fresh start, not toxic positivity: “This year was heavy. I hope the next one is kinder, and I am here either way.”"],["Is it okay to send a New Year message late?","Yes. A thoughtful note in the first week of January often lands better than a rushed one at midnight."],["What do you write to a coworker or client?","Thank them for the year of working together and wish them a strong one ahead. Warm and brief beats effusive."]], related:["what-to-write-in-a-birthday-card","what-to-write-in-a-congratulations-card","ways-to-thank-someone-who-is-always-there"] },
  { slug:"what-to-write-in-a-teacher-thank-you-card", tone:"celebration", title:"What to Write in a Teacher Thank-You Card (That They'll Actually Keep)", meta:"Warm, specific ideas for what to write in a teacher thank-you card or end-of-year message, for parents and students.", h1:"What to write in a teacher thank-you card", begin:"I want to write a thank-you card for my child's teacher", intro:["Teachers hear “thank you for everything” a hundred times a year, and none of it tells them what they actually did. The cards they keep in a drawer for years are the ones that name a real moment.","Here's how to write one that lands, whether your kid is signing it or you are."], matters:"Most teachers never find out the specific difference they made. Naming it is the whole gift.", say:[["“You're the reason reading finally clicked for her this year.”","Names the exact thing that changed."],["“He was dreading fourth grade, and you turned it into the year he loved school.”","Tells them they changed how a kid feels about learning."],["“Thank you for being patient with him on the hard days. He noticed, and so did we.”","Credits something a teacher rarely hears was seen."],["“You made history feel like stories instead of dates, and I still think about it.”","Works in a student's own voice about a subject they made click."]], avoid:[["“Thanks for everything this year!”","Could be written to any teacher about anything."],["“Sorry this is just a small gift.”","Turns their card into an apology about you."],["“You're the best teacher ever!”","Feels nice for a second, then tells them nothing."]], gestures:[["Name one concrete thing","A subject that clicked, a hard stretch they carried you through."],["Let your kid add a line","Even a crooked sentence in their own handwriting means the most."],["Say it out loud at pickup too","A spoken thank-you and a written one land differently, and both stick."],["Keep it honest, not fancy","Plain and true beats polished every time."]], sections:[{h:"What to write for different situations",rows:[["From a young child (a parent helps write)","Keep it to one true thing in the child's words: “I like when you read to us.” Let them sign it themselves."],["From a parent","Tell the teacher the change you saw at home, not just in class. That's the proof their work reached the kid."],["At the end of the school year","Look back at where your kid started and where they landed, and give the teacher credit for the distance."],["A teacher who truly changed things for your kid","Be specific about the before and after. Say plainly that this was the year that turned something around."],["A retiring or departing teacher","Tell them their work outlasts this one classroom, and name the kid who will carry it forward."]]}], followUp:"Notice the small wins your kid brings home this year and tell the teacher about them while they're happening, not only in June.", faq:[["What do you write in a teacher thank-you card?","Name one specific thing the teacher did and the difference it made for your child. Skip the general praise."],["What can a young child write to their teacher?","One honest sentence in their own words about something they liked, plus their own signature. Simple beats polished."],["What's a good end-of-year message for a teacher?","Point to where your kid started the year and where they finished, and give the teacher credit for that growth."],["Should I mention the gift in the card?","No. Let the words stand on their own and let any gift just be a bonus, not the subject."],["How do I thank a teacher who really changed my kid's year?","Describe the before and after plainly, and tell them straight out that they were the reason it turned around."],["How long should a teacher thank-you note be?","A few real sentences. One specific memory beats a full page of nice-sounding lines."]], related:["what-to-write-in-a-thank-you-card","ways-to-thank-someone-who-is-always-there","what-to-write-in-a-graduation-card"] },

  // ---- Batch 8 (TC-175 wave 3): evergreen matrix expansion ----
  { slug:"what-to-say-when-someone-is-pregnant", tone:"celebration", title:"What to Say When Someone Is Pregnant", meta:"Warm, genuine ways to respond when someone tells you they are pregnant.", h1:"What to say when someone tells you they are pregnant", begin:"A friend just told me they are pregnant", intro:["Someone just shared one of the biggest pieces of news a person can share, and how you respond becomes part of how they remember the moment.","The good news is that this is simpler than it feels. Match their energy, make it about them, and let your warmth do the work."], matters:"The most meaningful thing you can do is match their joy and follow their lead, because not every pregnancy is met with the same certainty, and your job is to meet them where they actually are.", say:[["“This is wonderful news. I am so happy for you.”","Clear, warm, and impossible to misread."],["“How are you feeling about it all?”","Opens the door without assuming how they feel."],["“I am so glad you told me.”","Honors the trust it took to share."],["“You are going to be so loved by this little one.”","Celebrates them, not just the pregnancy."]], avoid:[["“Was this planned?”","Turns a happy moment into an interrogation."],["“You are going to be huge, just wait.”","Comments on their body they did not ask for."],["“Let me tell you about my delivery.”","Hijacks their news with a story or a warning."]], gestures:[["Let them set the pace","Some people want to talk for an hour, others just wanted you to know. Follow their cue."],["Send a note a few days later","A warm message after the initial rush tells them the joy stuck with you."],["Ask what kind of support they want","Meals, company, or just someone who does not make it a big production."],["Keep their news theirs","Do not share it onward until you know they are ready for you to."]], gesturesHeading:"Small ways to show up well", sections:[{h:"What to say depending on the situation",rows:[["A close friend or sibling","Skip the polish and be real. Tell them exactly how excited you are, then ask how they are actually doing underneath the excitement."],["A coworker","Keep it warm and brief. A simple 'congratulations, that is lovely news' respects the moment without prying into anything personal."],["A first-time parent","They may be equal parts thrilled and nervous. Celebrate first, then reassure them that they do not have to have it all figured out yet."],["Someone who took a long or hard road to this","Let the weight of it show. 'I know how much this means to you' says you have not forgotten what it took to get here."],["When you are not sure how they feel about it","Lead with a neutral, caring opener like 'how are you feeling about it?' and let their answer tell you whether to celebrate loudly or simply be present."]]}], followUp:"Check in a few weeks later with a simple 'how are you doing?' that is about them as a person, not a status update on the pregnancy.", faq:[["What do you say when someone tells you they are pregnant?","Lead with genuine happiness and make it about them, something like 'this is wonderful news, I am so happy for you,' then ask how they are feeling rather than jumping to questions."],["What should you not say to a pregnant person?","Avoid intrusive questions like whether it was planned, comments about their body or weight, and unsolicited advice or scary birth stories. None of it is yours to bring up."],["What if I am not sure they are happy about the pregnancy?","Start neutral and caring. Ask how they are feeling about it and let their answer guide you, so you can celebrate loudly or simply be a steady presence."],["How do I respond to a coworker who is pregnant?","Keep it warm and brief. A sincere 'congratulations, that is lovely news' is perfect, and you can leave anything more personal for them to raise."],["Is it okay to ask questions when someone shares they are pregnant?","Open-ended and caring questions are welcome, like 'how are you feeling?' Avoid the prying kind about planning, timing, or their body."],["What is a thoughtful thing to do after someone tells me they are pregnant?","Send a warm note a few days later and offer specific, low-pressure support, and keep their news private until they are ready to share it more widely."]], related:["what-to-write-in-a-baby-shower-card","what-to-write-in-a-new-baby-card","how-to-help-new-parents"] },
  { slug:"what-to-say-to-someone-struggling-with-infertility", tone:"hard", title:"What to Say to Someone Struggling With Infertility", meta:"Gentle, honest things to say to someone struggling to get pregnant or going through IVF, and what to avoid.", h1:"What to say to someone struggling with infertility", begin:"A friend is struggling to get pregnant", intro:["Infertility is a grief that most people carry quietly. There is no funeral, no casserole, no obvious way for others to see the hope that gets raised and dropped month after month. That silence is part of what makes it so lonely.","You do not need to fix anything or know the medicine. What helps most is letting them know they are not carrying this alone, and following their lead on how they want to talk about it."], matters:"So much of the pain here is invisible, and the people around them often fill the silence with advice instead of comfort.", say:[["“I'm so sorry you're going through this. I'm here, and you don't have to explain anything.”","Offers presence without asking them to perform hope or update you."],["“This sounds really hard. How are you actually doing with it?”","Invites the real answer instead of the polite one, and lets them set the depth."],["“I don't have the right words, but I love you and I'm not going anywhere.”","Honesty about not knowing what to say lands better than a tidy line."],["“Tell me what would feel supportive right now, and what wouldn't.”","Hands them control of a situation where they have had very little."]], avoid:[["“Just relax and it'll happen.”","Implies they caused it by trying too hard, which is both untrue and cruel."],["“Have you tried acupuncture, this diet, that clinic?”","Turns their pain into a problem for you to solve, and assumes they haven't tried."],["“At least you can always adopt.”","Erases this specific loss and pressures a decision that is theirs alone."]], gestures:[["Check in between the big moments","A quiet “thinking of you today” on an ordinary week says you're still holding it."],["Follow their lead on baby news","Let them tell you how much they can hold, and warn them before a big announcement if you can."],["Show up without a fix","Bring the coffee, sit through the appointment day, ask nothing in return."],["Remember the calendar they're living by","Cycles, wait dates, and results days are heavy; a note on those days means everything."]], gesturesHeading:"Small ways to show up", sections:[{ h:"What to say in different moments", rows:[["After a failed cycle or a negative test","Don't rush to next time. Try “I'm so sorry. You don't have to be okay about this today.” Let the disappointment be real before any hope."],["When they're deep in treatment","The waiting is exhausting. Offer something concrete: “Can I drive you to the appointment, or bring dinner after?” Steady logistics beat cheerful pep talks."],["A friend who just confided in you","They chose you on purpose. Try “Thank you for telling me. I'll follow your lead on this, always.” Then keep it to yourself unless they say otherwise."],["Navigating pregnancy announcements around them","Give a heads-up in private: “I have some news to share, and I wanted you to hear it from me first, in your own time.” The warning is the kindness."]] }], followUp:"This grief runs on a calendar you can't see, so keep checking in gently long after the first conversation. Ask how they're doing, then believe whatever answer they give.", faq:[["What do you say to someone struggling to get pregnant?","Keep it simple and warm. Acknowledge that it's hard, tell them you're there, and ask what would actually feel supportive instead of offering advice."],["What should you not say to someone with infertility?","Skip “just relax,” “have you tried,” “everything happens for a reason,” and “at least you can adopt.” They minimize a real loss or turn it into a project to fix."],["Should I give advice or suggest treatments?","No. Unless they ask, leave the medicine to their doctors. Assume they've researched more than you have, and offer presence instead of tips."],["How do I share pregnancy news with a friend going through infertility?","Tell them privately and ahead of time, and let them react on their own terms. The gift is the warning, so they aren't caught off guard in public."],["What if I don't know what to say?","Say exactly that. “I don't have the right words, but I'm here” is honest and kind, and far better than a cheerful line that misses the mark."],["How do I keep supporting them over time?","Check in on the quiet weeks, not just the milestones. Follow their language for it, and stay close without needing updates or a happy ending."]], related:["what-to-say-after-a-miscarriage","what-to-say-to-someone-having-a-hard-week","ways-to-help-a-grieving-friend"] },
  { slug:"what-to-say-when-someone-pet-is-dying", tone:"hard", title:"What to Say When Someone's Pet Is Dying", meta:"A friend's pet is dying and you don't know what to say. How to support the euthanasia decision, ease their guilt, and be there through anticipatory grief.", h1:"What to say when someone's pet is dying", begin:"A friend's pet is dying and I don't know what to say", intro:["Watching a pet decline is its own kind of grief, and it often starts long before the pet is gone. Your friend may be carrying an impossible decision, a countdown, and the fear that nobody sees this as the real loss it is.","Take it seriously, follow their lead, and never push them toward or away from a choice that only they can make. Here's what helps."], matters:"They are grieving someone who is still here, and often facing a decision no love could ever make easy. What they need most is for you to treat this as real and to sit close while it hurts.", say:[["“This is so hard, and I'm right here with you through all of it.”","Names the weight without rushing them toward the end."],["“There's no perfect timing for this. You know them better than anyone, and you're making this choice out of love.”","Meets the euthanasia decision without steering it, and eases the fear of getting it wrong."],["“Tell me about them. What are they like?”","Lets the pet be a whole life, not just a diagnosis."],["“Whatever you decide, and whenever, I'll be here after too.”","Promises you won't disappear once the hardest day passes."]], avoid:[["“It's just a pet.”","Erases a bond that is family to them."],["“You can always get another one.”","No one replaces the one they're losing, and they can't think past this yet."],["“You'll know when it's time.”","Sounds kind but quietly loads them with all the pressure of being certain."]], gestures:[["Offer to go with them","The vet visit, or just the drive. No one should sit in that waiting room alone."],["Handle a small thing","Bring food, walk the other dog, take something off their plate so they can just be present."],["Say the pet's name","In your texts, out loud, however you talk to them. It tells them you see who is being lost."],["Just be reachable","Let them know you're a call away at any hour, especially the night before and the day of."]], gesturesHeading:"Small ways to show up", sections:[{h:"What to say in different moments",rows:[["When they're facing the decision","“You don't have to have this figured out today. I'm here to think it through with you, or just to sit with you.” Don't cast a vote. Reflect back what they're weighing and let them land on their own."],["The day of","“I'm thinking of you every minute today. You don't have to reply.” Keep it short and steady. Offer to come, and honor it if they'd rather be alone."],["When guilt hits over the timing","“You didn't fail them. You spared them, and that was the last kind thing you could give.” The what-ifs will come no matter what they chose. Meet each one with reassurance, not logic."],["After, in the quiet","“How are you today, really?” The house goes silent in a way that catches them off guard. Keep checking in past the first week, when everyone else has moved on."]]}], followUp:"After the goodbye, the quiet is the hardest part: the empty bed, the leash by the door, the routine that no longer has them in it. Check in a week later, and again after that. Grief for a pet lingers long after the world assumes it's over.", faq:[["What do you say to someone whose pet is dying?","Take it seriously as real grief, follow their lead, and let them talk about their pet. Say something like “This is so hard, and I'm here with you through all of it.” Don't rush them or minimize what they're losing."],["How do I support someone deciding whether to put their pet down?","Support the person, not a particular choice. Reflect back what they're weighing and reassure them there's no perfect timing and that this is an act of love. Never tell them what to do, and never say “you'll know when it's time,” which only adds pressure."],["How do I comfort someone feeling guilty about the timing?","Meet the guilt with reassurance rather than argument. Remind them they didn't fail their pet, they spared them suffering, and that ending pain was a final act of love. The what-ifs come no matter what anyone chooses."],["What should I not say?","Don't say “it's just a pet,” “you can always get another one,” or “you'll know when it's time.” They dismiss the bond or quietly load the person with pressure. Skip advice about the medical decision entirely."],["Is it normal to grieve before the pet is even gone?","Yes. Anticipatory grief is real, and losing a pet slowly can be its own long goodbye. Naming it and staying close matters as much as anything you say after."],["How do I keep helping after the pet is gone?","Keep showing up past the first week. Check in when the house feels emptiest, say the pet's name, and let them talk. Grief for a pet lasts far longer than most people expect."]], related:["what-to-say-when-someone-loses-a-pet","ways-to-help-a-grieving-friend","what-to-say-to-someone-having-a-hard-week"] },
  { slug:"how-to-apologize-to-a-friend", tone:"everyday", title:"How to Apologize to a Friend and Really Mean It", meta:"How to apologize to a friend the right way, plus what to say when you're sorry.", h1:"How to apologize to a friend", begin:"I need to apologize to a friend and want to get it right", intro:["When you have hurt someone you care about, a rushed 'sorry' can make things worse. A real apology slows down and names what actually happened.","Here's how to say sorry in a way your friend can feel, without excuses or pressure to be forgiven right away."], matters:"A real apology names the specific thing, owns it without excuses, acknowledges how it landed, and leaves the choice to forgive up to them.", say:[["“I'm sorry I canceled on you last minute again. That was your night and I let you down.”","Name the specific thing you did, not a vague 'sorry for everything.'"],["“I can see how that hurt, and I don't blame you for being upset.”","Acknowledge the impact from their side, not just your intent."],["“I was wrong. There's no excuse for it.”","Own it cleanly, with no 'but' attached."],["“You don't have to be okay with me right now. I just wanted you to hear it.”","Give them room instead of demanding forgiveness."]], avoid:[["“I'm sorry you feel that way.”","This blames their reaction instead of owning your action."],["“I'm sorry, but you did the same thing to me.”","The 'but' cancels the apology and starts a fight."],["“I already said sorry, what more do you want?”","Impatience tells them the apology was about you, not them."]], gestures:[["Apologize in person or by voice","Tone carries what a text can't. Call or say it face to face when you can."],["Give it time to land","Say your piece, then let them react without rushing to smooth it over."],["Change the thing, not just the words","If it happens twice, the second apology means nothing without a real fix."],["Follow through quietly","Show up differently next time instead of announcing how sorry you are."]], gesturesHeading:"Beyond the words", sections:[{h:"How to apologize in different situations",rows:[["When you hurt them badly","Slow all the way down. Name exactly what you did, say plainly that you were wrong, and let them feel it without steering them toward 'we're good.' Do not ask for forgiveness in the same breath."],["When you're not fully sure what you did","Lead with 'I can tell I hurt you and I want to understand how.' Own the effect while you learn the cause, and listen more than you explain."],["A small everyday slip","Keep it light and direct. 'That came out wrong, I'm sorry.' Repair it fast so a tiny thing doesn't harden into a grudge."],["When you need to apologize but also set a boundary","Own your part fully first, in its own moment. Raise the boundary later as a separate conversation so it doesn't read as 'sorry, but really it's your fault.'"]]}], followUp:"Give them space to sit with it, then show the change in how you act, not in more words.", faq:[["How do you apologize to a friend you really hurt?","Name the specific thing you did, say clearly that you were wrong, acknowledge how it affected them, and don't ask them to forgive you on the spot."],["What makes an apology sound fake?","Excuses, a 'but,' blaming their feelings, or bringing up what they did wrong. A real apology stays on your action alone."],["What should I not say when apologizing?","Skip 'I'm sorry you feel that way,' 'I'm sorry but,' and 'I already said sorry.' Those shift blame or ask for credit."],["Should I apologize by text or in person?","In person or by voice is better when you can, because tone carries sincerity. A thoughtful text is fine when distance or nerves make that impossible."],["What if they don't forgive me?","That's their right. Say your apology, mean it, change the behavior, and let them come around in their own time, or not."],["How do I apologize without making excuses?","Say what you did and stop before the word 'but.' Explaining why can come later, only if they ask for it."]], related:["what-to-say-to-someone-having-a-hard-week","ways-to-thank-someone-who-is-always-there","what-to-say-when-a-friend-moves-away"] },
  { slug:"what-to-say-to-someone-who-is-lonely", tone:"everyday", title:"What to Say to Someone Who Is Lonely", meta:"What to say to someone who is lonely, plus small, repeated ways to help them feel less alone.", h1:"What to say to someone who is lonely", begin:"Someone I care about seems really lonely", intro:["Loneliness is one of the hardest things to say out loud. Most people hide it, because admitting it can feel like admitting something is wrong with them. So if you have noticed it in someone, you are already doing more than most.","You do not have to fix their whole social life. What helps is showing up, saying you thought of them, and inviting them again and again until they believe you mean it."], matters:"Loneliness usually comes wrapped in a little shame, so the person rarely asks for company directly. Quiet, steady presence tells them they are wanted without making them confess how alone they feel.", say:[["“I was thinking about you today.”","Being remembered, unprompted, is the whole point. It tells them they take up space in someone's mind even when they are not in the room."],["“Come over Sunday, same as last time. I would love to have you.”","A concrete, repeating invitation is far easier to accept than a vague one. It gives them a standing place to belong."],["“You do not have to be good company. Just come as you are.”","This lifts the pressure to perform, which is often what keeps a lonely person home."],["“I miss you. Let's not let it go this long again.”","Naming that you feel the gap too makes the connection mutual, not charity."]], avoid:[["“You should get out more.”","It turns their loneliness into a personal failing and puts all the work back on them."],["“You have so many friends though.”","Numbers do not equal closeness, and this makes them feel unseen and a little ashamed for feeling alone."],["“Just join a club or something.”","A vague, generic fix skips over how hard it is to walk into a room of strangers when you already feel unwanted."]], gestures:[["Make a standing invitation","Same day, same time, every week or month, so they never have to wonder if they are welcome."],["Reach out first, on a random day","A text on an ordinary Tuesday lands harder than a holiday card. It says they are on your mind for no reason at all."],["Include them in small, low-key things","An errand, a walk, a coffee. Ordinary company is often more comforting than a big planned event."],["Follow up when they go quiet","Lonely people often disappear and assume no one will notice. Noticing, out loud, is the gift."]], gesturesHeading:"Small ways to help them feel less alone", sections:[{ h:"What to say to different people", rows:[["A friend who seems isolated","“I have missed having you around. Come do nothing with me Saturday.” Keep the ask small and repeat it, even if they pass the first time."],["An older parent or grandparent living alone","“I want to hear your voice, not just check a box. Can I call you every Sunday?” A predictable rhythm they can count on beats occasional long visits."],["Someone new to a city","“You do not know anyone yet, so consider me your first person here. Text me when you want company.” Offer to be the easy, no-pressure default."],["Someone lonely inside a relationship or a crowd","“You can be surrounded by people and still feel unseen. I see you, and I am glad you are here.” Name that this kind of lonely is real, not ungrateful."]] }], followUp:"Do not treat one good visit as the fix. Reach out again next week, and the week after. Steady beats grand.", faq:[["What do you say to someone who is lonely?","Lead with being thought of, then offer a specific, repeatable plan. Something like “I was thinking about you, come over Sunday” beats a vague “we should hang out sometime.”"],["What should I not say?","Skip anything that sounds like advice they did not ask for, like “get out more” or “just join a club.” It puts the burden back on them and can add shame."],["What if they keep turning down my invitations?","Keep offering anyway, gently and without guilt-tripping. For a lonely person, the standing invitation itself is comforting, even on the days they say no."],["How do I bring it up without embarrassing them?","You do not have to name their loneliness directly. Just show up and include them. Presence says it better than a conversation about it would."],["What if I feel far away or busy?","A short, honest text still counts. “You crossed my mind and I wanted you to know” takes ten seconds and can carry someone through a hard day."],["Can I help if I feel a little lonely too?","Yes, and saying so can help. “I have been missing real company lately, want to be lonely together?” turns it into something you share instead of something you pity."]], related:["what-to-say-to-someone-having-a-hard-week","how-to-support-a-friend-from-far-away","what-to-say-to-someone-who-is-depressed"] },
  { slug:"what-to-say-when-someone-adopts-a-child", tone:"celebration", title:"What to Say When Someone Adopts a Child", meta:"Warm, respectful things to say when someone adopts a baby or child, plus what to avoid.", h1:"What to say when someone adopts a child", begin:"Friends of mine are adopting a child", intro:["Adoption is a family beginning, and the parents are often riding a wave of joy after a long, uncertain road. What they want most is to be celebrated as a family, plainly, with no asterisk.","Here is what to say, what to leave out, and how to show up in a way they will remember."], matters:"The warmest words treat this child as fully theirs and celebrate the family that is forming, without questions that single anyone out.", say:[["“Congratulations. Your family just grew, and I could not be happier for you.”","Celebrates the family, full stop."],["“I cannot wait to meet them and love them like the rest of your crew.”","Signals the child belongs, no distinction."],["“You are going to be a wonderful parent.”","Speaks straight to their heart."],["“I am so happy for all of you. Tell me whatever you want me to know, whenever you want.”","Follows their lead on the story."]], avoid:[["“Are they your real kids? / their real parents?”","You are their real parents. Never frame it otherwise."],["“How much did it cost? / do you know their birth mom?”","Intrusive and not yours to ask."],["“Couldn't you have your own? / maybe now you'll get pregnant.”","Othering and hurtful; this is their own child."]], gestures:[["Bring a freezer meal","New parents by any path are tired and stretched thin."],["Add their child to the family fold","Include them the way you would any new niece, nephew, or friend's kid."],["Follow their lead on the story","Let the parents decide what gets shared and when; do not press for details."],["Give a gift for the parents too","Look after the grown-ups, not only the little one."]], gesturesHeading:"Ways to show up", sections:[{h:"What to say in different situations",rows:[["A newborn adoption","“Welcome to the world, little one. Your parents have been ready for you for a long time.” Same joy you would bring to any new baby."],["An older child or sibling group","“What a lucky family, all of you. I would love to help however makes life easier right now.” Celebrate the whole group; skip questions about their past."],["A friend who waited a long time","“You never gave up, and now here they are. I am so glad this day came.” Honor the wait without dwelling on the hard parts."],["What to write in a card","Keep it about the family: “Congratulations on your growing family. So much love to all of you.” Warm, simple, no story-digging."]]}], followUp:"Check in a few weeks later with a simple 'how are you all settling in?' and mean it about the parents too.", faq:[["What do you say when someone adopts a child?","Congratulate them as a family, plain and warm. Something like “Your family just grew and I am so happy for all of you” treats the child as fully theirs, which is exactly right."],["What should you not say?","Skip anything with “real” parents or “own” kids, and never ask about cost, the birth family, or why they did not have a baby another way. Those questions single people out and are not yours to ask."],["Is it okay to ask about the child's story?","Let the parents lead. If they want to share, they will. Your job is to celebrate and support, not to collect the backstory."],["How is this different from a new baby card?","It usually is not, and that is the point. Bring the same joy you would to any new arrival, and center the family rather than the how."],["What is a good gift?","A freezer meal, a gift for the parents themselves, or simply your time. New parents by any path are tired and could use the help."],["What if I do not know the details?","You do not need them. Celebrate the family in front of you and follow their cues from there."]], related:["what-to-write-in-a-new-baby-card","what-to-say-when-someone-is-pregnant","how-to-help-new-parents"] },
  { slug:"what-to-say-to-someone-whose-parent-has-dementia", tone:"hard", gesturesHeading:"Ways to actually show up", title:"What to Say to Someone Whose Parent Has Dementia", meta:"What to say to a friend whose parent has dementia or Alzheimer's, and how to support them.", h1:"What to say to someone whose parent has dementia", begin:"A friend's parent has dementia and I want to support them", intro:["Your friend is losing a parent slowly, in pieces, while that parent is still in the room. There is no clear moment to grieve and no permission to, because the world keeps saying how lucky they are to still have them.","You do not need the right words about memory or medicine. You need to stay close to the person watching it happen, and let them feel however they feel about it without fixing a single thing."], matters:"This is grief with no ending and no funeral, and almost no one treats it as loss.", say:[["“I can't imagine how strange it is to lose them while they're still here.”","Names the ambiguous loss out loud, which almost no one does."],["“You're allowed to grieve this, even now.”","Gives them permission the world keeps withholding."],["“How are YOU holding up in all of it?”","Turns the light onto them, not just the parent's condition."],["“You don't have to explain or update me. I just wanted you to feel me here.”","Removes the pressure to perform a status report."]], avoid:[["“At least they're still here.”","It erases a real, ongoing loss and shames the grief."],["“Do they still recognize you?”","Reduces the relationship to a test the parent keeps failing."],["“My grandma had that, it was awful.”","Turns their living heartbreak into your old story."]], gestures:[["Say the parent's name","Ask who they were before, and let your friend remember them out loud."],["Take one thing off the pile","Drop off a meal, run an errand, handle one call they've been dreading."],["Check in on a hard date","Birthdays and holidays sharpen the ache of who is fading; reach out then."],["Keep showing up as they change","This is long. Be the friend still here a year from now, not just this week."]], sections:[{h:"What to say based on your relationship",rows:[["A close friend who is the main caregiver","Care for them as a whole person, not a nurse. Offer one concrete break and ask about their own life."],["Someone grieving a parent who is 'still here'","Name the loss plainly. Say you see it as real grief, and don't rush them toward gratitude."],["A coworker stretched thin","Keep it light and human. “I don't know what you're carrying at home, but I've got your back here.”"],["Much later, as it progresses","Don't assume they've adjusted. Say “this doesn't get easier, does it,” and keep listening."]]}], followUp:"The hardest stretch is the long middle, when everyone else has moved on. Keep circling back to THEM.", faq:[["What do you say to someone whose parent has dementia?","Name that they're losing a parent who is still here, tell them they're allowed to grieve it, and ask how they are holding up. You don't need the perfect line, just to stay close."],["What should you not say?","Skip “at least they're still here” and “do they still recognize you.” Don't offer medical advice or make it about someone you knew with dementia."],["What is ambiguous loss?","It's grieving someone who is physically present but changed or fading, with no clear ending or permission to mourn. Naming it can be a relief to your friend."],["How do I support the caregiver, not just the patient?","Ask how THEY are as a person, offer one specific break instead of “let me know if you need anything,” and remember they have a life outside caregiving."],["What if I don't know what to say?","Say that. “I don't have the right words, but I'm not going anywhere” lands better than a tidy fix, and it's true."],["How often should I check in?","More than you think, and long after the first shock. This unfolds over years, so keep reaching out on hard dates and quiet ordinary weeks alike."]], related:["what-to-say-to-a-caregiver","what-to-say-to-someone-who-is-sick","ways-to-help-a-grieving-friend"] },
  { slug:"what-to-say-when-you-forgot-someones-birthday", tone:"everyday", title:"What to Say When You Forgot Someone's Birthday", meta:"Warm, no-grovel ways to say sorry for a forgotten or belated birthday.", h1:"What to say when you forgot someone's birthday", begin:"I forgot someone's birthday and feel terrible", intro:["Forgetting a birthday feels awful, but it is a small thing you can make right in a warm, human way.","The move is to own it, skip the excuses, and offer something real to make up for it."], matters:"What people remember is not the miss, it is whether you <em>showed up</em> once you realized.", say:[["“Your birthday completely got away from me, and I hate that. Belated, but I mean it: I'm so glad you're here.”","Owns it and lands on them, not on your guilt."],["“I missed your day and I'm not going to pretend I didn't. Let me take you out this week to make up for it.”","Pairs the apology with a real plan."],["“So I'm officially the friend who forgot your birthday. Consider this the start of a very long celebration.”","Light and warm, no spiral."],["“I dropped the ball on your birthday. You matter to me way more than that slip suggests.”","Names why they matter without over-explaining."]], avoid:[["“I've just been so busy and stressed and everything's been crazy.”","Turns their day into your excuse reel."],["“I'm the worst, I feel so guilty, I can't believe I did this.”","Makes them comfort you."],["“Happy belated!”","Too thin for a miss worth owning."]], gestures:[["Make the call, don't just text","A voice makes belated feel intentional."],["Offer a real plan","Dinner or a walk says the day still counts."],["Send something small and specific","A gift they'd love beats a generic apology."],["Mark it now for next year","So this is the last time it happens."]], sections:[{h:"What to say depending on who it is",rows:[["A close friend","Be honest and a little playful. They will forgive fast if you own it and make a plan."],["A family member","Warm and direct. Call, don't text, and name that you were thinking of them even if the date slipped."],["A partner (higher stakes)","No jokes to open. Own it fully, skip the excuses, and follow with a real gesture that shows they come first."],["A coworker or acquaintance","Keep it light and brief. A quick belated note plus a coffee offer is plenty."]]}], followUp:"Actually do the thing you offered. A plan you keep repairs it; a plan you drop makes it worse.", faq:[["What do you say when you forgot someone's birthday?","Own it simply, skip the excuses, and offer something real like a call or a plan. Try: your day got away from me and I hate that, let me make it up to you."],["Is it too late to wish someone a belated happy birthday?","No. A warm belated message almost always lands well, especially if you add a real gesture rather than just the words."],["Should I explain why I forgot?","No. Explanations sound like excuses and shift the focus to you. Own the miss and move to making it up to them."],["How do I apologize without making it awkward?","Keep it short and human, add a touch of warmth or lightness, and end on a plan. Do not spiral so they feel they have to comfort you."],["What if it's my partner's birthday I forgot?","Skip the jokes, own it fully, and back it with a real gesture. With higher stakes, effort matters more than the perfect words."],["Is a text enough or should I call?","For anyone close, call. A voice makes a belated wish feel intentional instead of like an afterthought."]], related:["what-to-write-in-a-birthday-card","how-to-apologize-to-a-friend","ways-to-thank-someone-who-is-always-there"] },
];
